...
<tr>
          <td width="80"  align="center" valign="middle" class="hovergallery"><p align="center"><a href="http://www.inmobiliariaabcperu.com"><div id="shape2" style="position:static; left:-200px; top:2px; right :-200px;>
            <div align="center">
            <div align="center"><img border=0 width="1222" height="145" alt="" src="iconos/parabanner.png"></div>
          </div>
          </div>
          </a>
	  </label>
	...
	<table width="1200" border="0" align="center">
		<tbody>
			...
			<a href="../folleto/busca_folleto.php?cod_inmueble=<?=$row['cod_inmueble'];?>"> Folleto</a> | &nbsp;
			<a href="../folleto/buscar_porcentaje.php?cod_inmueble=<?=$row['cod_inmueble'];?>"> % </a> | &nbsp;
			<a href="../folleto/detalles/buscar_detalles.php?cod_inmueble=<?=$row['cod_inmueble'];?>"> Inf.</a>
...
?>                                         
                                ...
                                <td width="60%" style="vertical-align:text-top;">
                                    <table width="100%">
                                        ...
                                        <tr>
                                        	<td style="padding-top: 15px;color:#3ADF00;font-size: 20px;">
					<?=utf8_encode(ucfirst(strtolower($row_provincia[1])))." - ".utf8_encode(ucfirst(strtolower($row_distrito[2])))?>
                                                <br/>
                                                <span style="color: #3ADF00;font-size: 15px;font-family: Arial,Helvetica,"Nimbus Sans L",sans-serif;">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td width="50%" bordercolor="#FFFFFF" bgcolor="#EDEDED" style="color:#999;font-size:24px"><span class="Estilo1">
                                               	  Caracteríticas del Inmueble:<br/>
                                               	<br/>                                              
                                           	  </span></td>
                                			</tr>
                                            <tr>
...
if($row[79] != "" && $row[79] != "0")
	echo "<ul style='display:inline;color:#333;'><strong>Lavanderia</strong>: ".utf8_encode($row[79])."</ul>";
if($row[80] != "" && $row[80] != "0")
	echo "<ul style='display:inline;color:#333'><strong>Piscina</strong>: ".utf8_encode($row[80])."</ul>";
if($row[81] != "" && $row[81] != "0")
	echo "<ul style='display:inline;color:#333'><strong>Seguridad</strong>: ".utf8_encode($row[81])."</ul>";
if($row[70] != "" && $row[70] != "0")
	echo "<ul style='display:inline;color:#333'><strong>Piso</strong>: ".utf8_encode($row[70])."</ul>";

if($row[82] != "" && $row[82] != "0")
	echo "<ul style='display:inline;color:#333'><strong>BBQ</strong>: ".utf8_encode($row[82])."</ul>";
if($row[83] != "" && $row[83] != "0")
	echo "<ul style='display:inline;color:#333'><strong>Parque Infantil</strong>: ".utf8_encode($row[83])."</ul>";	

if($row[84] != "" && $row[84] != "0")
	echo "<ul style='display:inline;color:#333'><strong>Mascotas</strong>: ".utf8_encode($row[84])."</ul>";
if($row[85] != "" && $row[85] != "0")
	echo "<ul style='display:inline;color:#333'><strong>GYM</strong>: ".utf8_encode($row[85])."</ul>";	
...
if($row[78] != "" && $row[78] != "0")
	echo "<ul style='display:inline;color:#333'><strong>Vista</strong>: ".utf8_encode($row[78])."</ul>";
if($row[62] != "" && $row[62] != "0")
